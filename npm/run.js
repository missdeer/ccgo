...
const PLATFORMS = {
  "darwin-x64": "@ccgonext/darwin-universal",
  "darwin-arm64": "@ccgonext/darwin-universal",
  "linux-x64": "@ccgonext/linux-x64",
  "linux-arm64": "@ccgonext/linux-arm64",
  "win32-x64": "@ccgonext/win32-x64",
  "win32-arm64": "@ccgonext/win32-arm64",
};
...
function getBinaryPath() {
  ...
  try {
    ...
    console.error("  npm install ccgonext");
    console.error("");
