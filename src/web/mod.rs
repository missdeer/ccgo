...
impl WebServer {
    ...
    pub async fn run(&self) -> anyhow::Result<()> {
        ...
        let app = Router::new()
            ...
            .route("/api/agents/:name/start", post(api_start_agent))
            .route("/api/agents/:name/stop", post(api_stop_agent))
            .route("/api/agents/:name/interrupt", post(api_interrupt_agent))
